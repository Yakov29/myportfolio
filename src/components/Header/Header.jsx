...
const Header = () => {
  return (
    <header className="header">
      <Container>
        <a className="header__github" target="_blank" href="https://github.com/Yakov29"><img className="header__github-img" src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="GitHub Profile" /></a>
      ...
      <button className="header__theme-toggle"><MdSunny /></button>
